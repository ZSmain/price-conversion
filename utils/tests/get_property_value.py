...
class TestGetPropertyValue(TestCase):
    ...
    def test_01_primitives(self):
        ...
        self.assertEqual(
            get_property_value(self.string, "length", default="default"), "default"
        )
    ...
    def test_02_dictionary_access(self):
        ...
        self.assertEqual(
            get_property_value(self.dict_john, "address", "street"), "93 Main St"
        )
        ...
        self.assertEqual(
            get_property_value(self.dict_john, "nonexistent", default="default"),
            "default",
        )
    ...
    def test_03_object_access(self):
        ...
        self.assertEqual(
            get_property_value(self.object_jane, "name"), self.object_jane.name
        )

        # Nested attribute access
        self.assertEqual(
            get_property_value(self.object_jane, "address", "street"),
            self.object_jane.address["street"],
        )
        ...
        self.assertEqual(
            get_property_value(self.object_jane, "nonexistent", default="default"),
            "default",
        )
